...
<head>
     <meta charset="UTF-8" />
    <title>Juwita-Shop | Login Page</title>
   ...
   <!-- PAGE CONTENT --> 
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            ...
            <form action="login/login" class="form-signin" method="POST">
                <p class="text-muted text-center btn-block btn btn-primary btn-rect">
                    Enter your username and password
                </p>
                <input type="text" placeholder="Username" class="form-control" name="username" value="<?php echo set_value('username')?>" />
